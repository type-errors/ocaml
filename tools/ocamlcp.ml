...
module Options = Main_args.Make_bytecomp_options (struct
  ...
  let _multi_type_errors = option "-type-errors"
  let _type_infer_left_to_right = option "-left-to-right"
  let _type_infer_right_to_left = option "-right-to-left"
  let _type_infer_random_order = option "-random-order"
