...
module Options = Main_args.Make_bytecomp_options (struct
  ...
  let _multi_type_errors = option "-multi-type-errors"
  let _type_infer_left_to_right = option "-type-infer-left-to-right"
  let _type_infer_right_to_left = option "-type-infer-right-to-left"
  let _type_infer_random_order = option "-type-infer-random-order"
