...
module Options = Main_args.Make_ocamldoc_options(struct
  ...
  let _multi_type_errors = set Clflags.multi_type_errors
  let _type_infer_left_to_right = set Clflags.type_infer_left_to_right
  let _type_infer_right_to_left = set Clflags.type_infer_right_to_left
  let _type_infer_random_order = set Clflags.type_infer_random_order
