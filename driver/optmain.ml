...
module Options = Main_args.Make_optcomp_options (struct
  ...
  *)
  ...
  let _multi_type_errors = set multi_type_errors
  let _type_infer_left_to_right = set type_infer_left_to_right
  let _type_infer_right_to_left = set type_infer_right_to_left
  let _type_infer_random_order = set type_infer_random_order
