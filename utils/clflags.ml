...
and multi_type_errors = ref false       (* -multi-type-errors *)
and type_infer_left_to_right = ref false  (* -type-infer-left-to-right *)
and type_infer_right_to_left = ref false  (* -type-infer-right-to-left *)
and type_infer_random_order = ref false   (* -type-infer-random-order *)
