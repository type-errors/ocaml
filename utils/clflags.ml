...
and multi_type_errors = ref false       (* -type-errors *)
and type_infer_left_to_right = ref false  (* -left-to-right *)
and type_infer_right_to_left = ref false  (* -right-to-left *)
and type_infer_random_order = ref false   (* -random-order *)
